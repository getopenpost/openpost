			...
			<div>
				...
				{#if requiresProviderApproval}
					...
					>
						...
						Your provider app may require approval before it can publish.
					</p>
				{/if}
	...
	<div class="marketing-shell">
		<div class="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-end">
			...
			<p class="marketing-copy lg:justify-self-end">
				OpenPost validates the text and media profile selected for this destination.
			</p>
		</div>
...
<section class="section-pad border-y bg-muted/20">
	<div class="marketing-shell grid gap-14 lg:grid-cols-2">
		<div>
			<p class="section-label">Connect and verify</p>
...
<section class="section-pad">
	<div class="marketing-shell grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
		<h2 class="marketing-heading">Use the current callback, scope, and media setup.</h2>
		<div>
			<p class="marketing-copy">
				Provider consoles change. The OpenPost guide records the configuration and checks the
				adapter expects.
			</p>
