...
- Use the shared Shadcn-svelte form primitives in both the app and marketing site. `pnpm check:ui-consistency` rejects visible native form controls outside the shared implementations.
