...
| `OPENPOST_EMAIL_FROM`                           |                      Required when a mail provider is set | falls back to `OPENPOST_SMTP_FROM`           | Verified sender used for signup codes, password resets, and user notifications.                                                                                                                                                    |
...
| `OPENPOST_SMTP_HOST`                            |                           Required for the SMTP transport | empty                                        | SMTP host used for authentication and user notification mail.                                                                                                                                                                      |
...
| `OPENPOST_VIDEO_EDITOR_ENABLED`                 |                                                        No | `false`                                      | Enables the private-beta OpenPost Video Editor routes and authenticated cloud-project APIs. Keep disabled on public instances until the beta gates pass.                                                                                    |
...
| `OPENPOST_WHOP_FOUNDER_MONTHLY_PLAN_ID`         |                                    Required in cloud mode | empty                                        | Whop Founder monthly plan ID.                                                                                                                                                                                                      |
| `OPENPOST_WHOP_FOUNDER_ANNUAL_PLAN_ID`          |                                    Required in cloud mode | empty                                        | Whop Founder annual plan ID.                                                                                                                                                                                                       |
