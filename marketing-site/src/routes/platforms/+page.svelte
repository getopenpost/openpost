  ...
  >
    ...
    <div>
      <p class="marketing-copy">
        Every network has different formats, permissions, and media rules.
        OpenPost keeps those differences visible in the editor and platform
        guides.
      </p>
      <div class="mt-7 flex flex-wrap gap-3">
        <Button href={managedSignupUrl} size="lg">Try OpenPost</Button>
        <Button
          href="/tools/post-preview-generator"
          variant="outline"
          size="lg"
        >
...
<section class="section-pad">
  <div class="marketing-shell">
    <div
      class="grid gap-2 border-b pb-5 sm:grid-cols-[0.65fr_1.35fr] sm:items-end"
    >
