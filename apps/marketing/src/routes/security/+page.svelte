	...
	const controls = [
		{
			...
			icon: LockKeyhole,
			href: `${githubUrl}/blob/main/apps/server/internal/services/crypto/encrypt.go`
		},
		{
			...
			icon: UserRoundCheck,
			href: `${githubUrl}/blob/main/apps/server/internal/services/auth/auth.go`
		},
		{
			...
			icon: ShieldCheck,
			href: `${githubUrl}/blob/main/apps/server/internal/services/sessions/service.go`
		},
		{
			...
			icon: KeyRound,
			href: `${githubUrl}/blob/main/apps/server/internal/services/apitokens/service.go`
		},
		{
			...
			icon: GitBranch,
			href: `${githubUrl}/blob/main/apps/server/internal/api/handlers/mcp.go`
		}
	] as const;
