...
The machine-readable contract is available at [`/openapi.json`](/openapi.json). Generate clients from that file instead of copying request or response schemas into another document. For everyday scripting, skip the raw HTTP and use the [TypeScript SDK](/automate/sdk).
