...
<div className="provider-directory not-prose">
  <a href="/docs/self-hosting/integrations/bluesky">
    <img src="/docs/assets/logos/bluesky.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Bluesky</strong>
      <small>Handle and app password</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/mastodon">
    <img src="/docs/assets/logos/mastodon.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Mastodon</strong>
      <small>Connect through your server</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/pixelfed">
    <img src="/docs/assets/logos/pixelfed.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Pixelfed</strong>
      <small>Photo publishing on your server</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/peertube">
    <img src="/docs/assets/logos/peertube.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>PeerTube</strong>
      <small>Video publishing to a channel</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/lemmy">
    <img src="/docs/assets/logos/lemmy.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Lemmy</strong>
      <small>Post to communities</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/piefed">
    <img src="/docs/assets/logos/piefed.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>PieFed</strong>
      <small>Post to communities</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/discord">
    <img src="/docs/assets/logos/discord.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Discord</strong>
      <small>Channel webhook or server bot</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/telegram">
    <img src="/docs/assets/logos/telegram.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Telegram</strong>
      <small>Bot for a channel or group</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/linkedin">
    <img src="/docs/assets/logos/linkedin.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>LinkedIn</strong>
      <small>Personal profiles and Pages</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/x">
    <img src="/docs/assets/logos/x.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>X</strong>
      <small>Developer app with write access</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/facebook">
    <img src="/docs/assets/logos/facebook.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Facebook</strong>
      <small>Pages you manage</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/instagram">
    <img src="/docs/assets/logos/instagram.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Instagram</strong>
      <small>Professional account linked to a Page</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/threads">
    <img src="/docs/assets/logos/threads.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Threads</strong>
      <small>Threads API app</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/youtube">
    <img src="/docs/assets/logos/youtube.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>YouTube</strong>
      <small>Google OAuth and a YouTube channel</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/tiktok">
    <img src="/docs/assets/logos/tiktok.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>TikTok</strong>
      <small>Login Kit and Content Posting API</small>
    </span>
  </a>
  <a href="/docs/self-hosting/integrations/pinterest">
    <img src="/docs/assets/logos/pinterest.svg" className="docs-provider-icon" alt="" />
    <span>
