...
import { Anime4kUpscaler } from '../upscale/anime4k-upscaler';
import { canUpscale, upscaledSize } from '../upscale/upscale-size';
import type { UpscaleVariant } from '../upscale/upscale-variant';
