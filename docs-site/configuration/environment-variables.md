...
| `OPENPOST_PROVIDER_USAGE_RETENTION_DAYS` |                                                     No | `180`                                        | Retention for immutable provider-cost events. Startup pruning is bounded and never removes the open month.                                                   |
