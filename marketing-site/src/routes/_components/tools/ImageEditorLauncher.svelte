...
<div class="mt-8 overflow-hidden rounded-xl border bg-card">
	<div class="grid lg:grid-cols-[minmax(0,0.9fr)_minmax(30rem,1.1fr)]">
		<section class="flex flex-col p-5 sm:p-8 lg:p-10" aria-labelledby="image-editor-launch-title">
			<div
			...
			<p class="mt-3 max-w-xl leading-7 text-muted-foreground">
				The tool opens in OpenPost Image Editor. Layer controls, text, shapes, image adjustments,
				page ordering, and PNG, JPEG, or WebP export are ready without an account.
			</p>

			<ul class="mt-6 grid gap-3 text-sm sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
				<li class="flex items-center gap-2">
					<Check class="size-4 text-primary" /> No watermark
				</li>
				<li class="flex items-center gap-2">
					<ShieldCheck class="size-4 text-primary" /> Local browser storage
				</li>
				<li class="flex items-center gap-2">
					<Images class="size-4 text-primary" /> Multi-page designs
				</li>
				<li class="flex items-center gap-2">
					<MonitorSmartphone class="size-4 text-primary" /> Desktop and mobile
				</li>
			</ul>
