    ...
    <div class="grid gap-12 lg:grid-cols-[1fr_20rem] lg:items-end">
      <div class="max-w-4xl">
        ...
        <p class="marketing-copy mt-6">
          OpenPost lets you write once, tailor each account version, review it,
          and schedule it. Other products may offer stronger writing, customer
          care, social listening, or large-company controls. These guides show
          the differences.
        </p>
    ...
    <div class="grid gap-12 lg:grid-cols-[18rem_1fr]">
      <div>
        ...
        <p class="mt-4 leading-7 text-muted-foreground">
          Every guide states where the other product is a better fit. Plans and
          features can change after the review date.
        </p>
      </div>
  ...
  <div class="marketing-shell grid gap-10 lg:grid-cols-[0.65fr_1.35fr]">
    ...
    <div class="grid gap-5 sm:grid-cols-3">
      ...
      <div>
        ...
        <p class="mt-2 text-sm leading-6 text-muted-foreground">
          Every guide shows its review date so you know when to check the linked
          source again.
        </p>
      </div>
    </div>
