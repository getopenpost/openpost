...
const standardMotion: ThemeMotionTokens = {
	...
	loading: { duration: '900ms', easing: 'linear', distance: '0px', opacity: 0.45 },
	pageTransition: {
		duration: '240ms',
		easing: 'cubic-bezier(0.16, 1, 0.3, 1)',
		distance: '0.75rem',
