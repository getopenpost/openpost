...
type IdentityProvider struct {
	...
	UseUserInfo          bool      `bun:"use_userinfo,notnull,default:false" json:"use_userinfo"`
	RequireVerifiedEmail bool      `bun:"require_verified_email,notnull,default:true" json:"require_verified_email"`
	JITEnabled           bool      `bun:"jit_enabled,notnull,default:false" json:"jit_enabled"`
...
type OrganizationSSOPolicy struct {
	...
	PasswordLoginAllowed    bool      `bun:"password_login_allowed,notnull,default:true" json:"password_login_allowed"`
	...
	RequireTokenReauth      bool      `bun:"require_token_reauth,notnull,default:true" json:"require_token_reauth"`
