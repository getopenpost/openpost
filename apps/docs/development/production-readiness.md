...
- The public prices and limits live in `apps/marketing/src/routes/_marketing.ts`.
...
- The sitemap must include every current public page, platform guide, and tool.
