...
| `OPENPOST_OIDC_BOOTSTRAP_ALLOWLIST`             |                                                        No | empty                                        | Comma-separated exact `issuer|subject` pairs or emails that may become instance admin during environment-provider JIT.                                       |
...
| `OPENPOST_VIDEO_STUDIO_ENABLED`                 |                                                        No | `true`                                       | Enables local Video Studio routes and its authenticated cloud-project APIs.                                                                                  |
