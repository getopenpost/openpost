...
Start with one platform, confirm the callback works, then add another.
...
| --------- | ---------- | ----------- | --------------------------- | --------------- | --------------------------------------------------------------- | ---------------- | -------------------------------------------------------- |
| X         | Yes        | Yes         | Yes                         | Yes             | Yes; account tier and API quota set the limits                  | Yes              | Account and post numbers                                 |
...
- **YouTube:** Configure through the provider app registry with provider `youtube`. OpenPost connects a selected channel, uploads one video with privacy, metadata, thumbnail, and playlist settings, and supports comment replies and moderation. Test a live channel before depending on it.
