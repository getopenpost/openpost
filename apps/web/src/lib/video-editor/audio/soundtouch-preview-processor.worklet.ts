/* oxlint-disable anti-slop/no-unknown-parameters, anti-slop/require-safety-comment-for-type-assertion -- AudioWorklet globals expose browser-owned constructor and message contracts. */
import { TimeStretchFilter, TimeStretchProcessor } from './time-stretch';
import {
	SOUND_TOUCH_PREVIEW_PROCESSOR_NAME,
	type SoundTouchPreviewProcessorMessage
} from './soundtouch-preview-shared';
