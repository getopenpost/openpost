...
- `packages/plan-catalog` owns sellable plans, prices, and limits for marketing, signup, billing settings, and the generated Go catalog. Read `apps/docs/development/billing-and-usage.md` before changing pricing or quota scope.
