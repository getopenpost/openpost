	...
	<div class="marketing-shell grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
		...
		<div>
			<p class="marketing-copy">
				Every managed plan includes the same posting tools, account versions, API, CLI, and MCP
				access. Higher plans add more workspaces, accounts, posts, storage, or seats.
			</p>
	...
	<div class="marketing-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
		...
		<div>
			<p class="marketing-copy">
				...
				subscription. You provide the server, storage, backups, social apps, and social network API
				costs.
			</p>
			<Button
