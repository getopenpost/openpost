 ...
 * Stored as: { version: "1.0", updatedAt: number, projects: [{id, name, updatedAt}] }
 *
...
/**
 * Newest first — the order `index.json` is persisted in. Callers that serve
 * entries without a round-trip through disk must apply this themselves.
 */
