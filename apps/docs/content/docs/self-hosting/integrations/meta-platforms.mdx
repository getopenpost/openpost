...
```json
[
  {"provider":"facebook","client_id":"meta-app-id","client_secret":"meta-app-secret","redirect_uri":"https://your-domain.example/api/v1/accounts/facebook/callback"},
  {"provider":"instagram","client_id":"meta-app-id","client_secret":"meta-app-secret","redirect_uri":"https://your-domain.example/api/v1/accounts/instagram/callback"},
  {"provider":"threads","client_id":"threads-app-id","client_secret":"threads-app-secret","redirect_uri":"https://your-domain.example/api/v1/accounts/threads/callback"}
]
```
