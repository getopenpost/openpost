...
type BillingStatusResponse struct {
	...
	ProviderCosts     []usage.ProviderCostSummary `json:"provider_costs,omitempty" doc:"Hosted variable provider cost estimates, separate from the product subscription"`
}
