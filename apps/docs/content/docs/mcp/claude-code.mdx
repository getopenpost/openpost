...
Replace the hosted origin with your server's HTTPS origin and keep `/mcp`. If you prefer the [local bridge](/mcp/mcp-guide/self-hosted-and-local), install and authenticate it first, then add it instead:
