			...
			<section class="mt-8 border-y py-6" aria-labelledby="video-start-heading">
				...
				<div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
					...
					<a
						...
						class="group min-h-36 rounded-lg border bg-card p-4 text-left transition-colors hover:border-primary/50 hover:bg-muted/30 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
					>
