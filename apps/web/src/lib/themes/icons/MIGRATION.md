...
| lib/image-editor/components/asset-panel.svelte, lib/image-editor/components/image-editor-shell.svelte              | circle, square     | protected `editor-shape-rectangle`, `editor-shape-rounded-rectangle`, `editor-shape-ellipse` | concrete vector shape tools                       |
