...
>
	...
	>
		...
		<Menubar.Root class="ml-1 hidden h-8 gap-0 border-0 bg-transparent p-0 lg:flex" aria-label={m.studio_menus()}>
			...
			<Menubar.Menu value="view">
				...
				<Menubar.Content class="min-w-48">
					...
					<Menubar.CheckboxItem checked={focusedCanvas} onCheckedChange={(checked) => (focusedCanvas = checked)}>
