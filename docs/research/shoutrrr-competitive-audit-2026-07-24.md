...
> **Historical note:** This file records the product state on 24 July 2026. It is not a current feature comparison. OpenPost added analytics, comments and replies, opt-in inboxes, feedback, Discord webhooks, and other features after this review. See the [current user docs](https://openpo.st/docs/usage/) and [provider catalogue](https://openpo.st/docs/providers/) for current facts.
