						...
						<div class="grid grid-cols-2 gap-2">
							...
							<label class="grid gap-1 text-xs">
								...
								<AppSelect
									...
									options={[[100, m.studio_thin()], [200, m.studio_extra_light()], [300, m.studio_light()], [400, m.studio_regular()], [500, m.studio_medium()], [600, m.studio_semibold()], [700, m.studio_bold()], [800, m.studio_extra_bold()], [900, m.studio_black()]].map(
										([weight, label]) => ({
											value: String(weight),
											label: `${weight} — ${label}`
										})
