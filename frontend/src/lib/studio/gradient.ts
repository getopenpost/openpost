import type { StudioGradientStop, StudioGradientValue, StudioPaintPoint } from './types';

const FALLBACK_STOPS: StudioGradientStop[] = [
...
export function createStudioCanvasGradient(
...
export function gradientColorAt(gradient: StudioGradientValue, point: StudioPaintPoint): string {
	const stops = normalizedGradientStops(gradient.stops, gradient.reverse);
...
function safeGradientEnd(start: StudioPaintPoint, end: StudioPaintPoint): StudioPaintPoint {
