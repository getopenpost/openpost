...
export interface paths {
  ...
  "/accounts/{account_id}/refresh-metadata": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    post: operations["refresh-account-metadata"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  schemas: {
    ...
    AccountExport: {
      ...
      publication_authorizations:
        | components["schemas"]["AccountExportPublicationAuthorization"][]
        | null;
    ...
    OrganizationDeletionPreview: {
      ...
      readonly $schema?: string;
      access_effects:
        | ("organization_memberships" | "workspace_memberships" | "organization_credentials")[]
        | null;
      /** @description Latest local Paddle subscription state, or none */
      billing_state: string;
      blockers: components["schemas"]["WorkspaceDeletionBlocker"][] | null;
      irreversible_loss:
        | ("workspaces" | "content" | "connected_accounts" | "media" | "settings")[]
        | null;
      organization_id: string;
      organization_name: string;
...
export interface operations {
  ...
  "refresh-account-metadata": {
    parameters: {
      ...
      header?: never;
      path: {
        /** @description OpenPost account ID */
        account_id: string;
      };
      cookie?: never;
    };
