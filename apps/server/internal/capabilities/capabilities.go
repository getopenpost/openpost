...
func All() []Capability {
	...
	return []Capability{
		...
		defaultQueued(Capability{Provider: ProviderTelegram, Profile: models.ContentProfileShortVideo, Label: "Telegram video", TextLimit: 1024, Media: telegramMedia, Settings: telegramSettings()}),
