...
The [Directus walkthrough](#publish-to-directus) below uses the connector included in the repository. To write another connector, read [Connector Protocol 1.0](../../development/connector-protocol.md).
...
The source lives in [`docs/examples/connectors/directus`](https://github.com/getopenpost/openpost/tree/main/docs/examples/connectors/directus).
...
```bash
cd docs/examples/connectors/directus
...
```bash
docker build -t openpost-directus-connector docs/examples/connectors/directus
```
...
Use the registry example above or copy [`openpost-connectors.example.json`](https://github.com/getopenpost/openpost/blob/main/docs/examples/connectors/directus/openpost-connectors.example.json). The sample expects a container named `directus-connector` at `http://directus-connector:8787`.
...
See [Connector Protocol 1.0](../../development/connector-protocol.md) for the route contract and publish safety rules.
