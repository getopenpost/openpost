...
<SetupScreenshot
  src="/docs/assets/screenshots/connect-mastodon-light.webp"
  darkSrc="/docs/assets/screenshots/connect-mastodon-dark.webp"
  alt="OpenPost connection dialog for Mastodon server address"
  width={976}
  height={478}
  caption="Mastodon server address in OpenPost. Screenshot uses example values."
/>
