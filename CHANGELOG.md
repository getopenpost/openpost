...
- Kept the Studio canvas point beneath the mouse or pinch midpoint fixed while zooming, shortened the rounded-shape label, and tightened desktop tool menus.
