...
Create a TikTok developer app, add Login Kit and Content Posting API, and request the scopes needed by your publishing mode. Register:
...
```json
[{"provider":"tiktok","client_id":"your-client-key","client_secret":"your-client-secret","redirect_uri":"https://your-domain.example/api/v1/accounts/tiktok/callback"}]
```
