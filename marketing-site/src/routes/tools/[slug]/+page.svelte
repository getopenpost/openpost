<script lang="ts">
	...
	> = {
		...
		'post-preview-generator': {
			...
			heading: 'Preview the destination before you publish',
			description:
				'Check text, images, video, polls, links, content warnings, and supported formats across all ten OpenPost destinations.'
		},
		'thread-splitter': {
