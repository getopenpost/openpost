...
<SetupScreenshot
  src="/assets/screenshots/integrations/tiktok-create-app.png"
  alt="TikTok Connect an app dialog with OpenPost as the example app name"
  width={1092}
  height={1440}
  caption="Give the TikTok developer app a name you will recognize."
  sourceUrl="https://docs.postiz.com/self-host/providers/tiktok"
  edited
/>
