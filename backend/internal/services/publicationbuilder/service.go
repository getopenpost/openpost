...
func (service *Service) BuildWithProgress(
	...
	if len(supported) == 0 {
		return BuildResult{}, errors.New("none of the selected destinations has a native builder adapter")
	}
...
func (service *Service) review(
	...
	generated, err := service.generator.Generate(ctx, ai.GenerateRequest{
		...
		MaxOutputTokens: 2_000, ReasoningEffort: ai.ReasoningEffortMedium,
	})
	if err != nil {
