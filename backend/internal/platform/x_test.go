...
func TestXPublishingCapabilitiesUseSubscriptionType(t *testing.T) {
	tests := []struct {
		...
		{subscriptionType: XSubscriptionTypeNone, textLimit: XStandardTextLimit, videoSeconds: XStandardVideoDurationSeconds},
		{subscriptionType: XSubscriptionTypeUnknown, textLimit: XStandardTextLimit, videoSeconds: XStandardVideoDurationSeconds},
		{subscriptionType: XSubscriptionTypeBasic, textLimit: XPremiumTextLimit, videoSeconds: XPremiumVideoDurationSeconds, premium: true},
		{subscriptionType: XSubscriptionTypePremium, textLimit: XPremiumTextLimit, videoSeconds: XPremiumVideoDurationSeconds, premium: true},
		{subscriptionType: XSubscriptionTypePremiumPlus, textLimit: XPremiumTextLimit, videoSeconds: XPremiumVideoDurationSeconds, premium: true},
	}
