...
type Config struct {
	...
	XContentCreateCostMicrousd        int64
	XContentCreateWithURLCostMicrousd int64
...
func Load() *Config {
	...
	cfg := &Config{
		...
		XMonthlyBudgetMicrousd:            int64(getEnvInt("OPENPOST_X_MONTHLY_BUDGET_MICROUSD", 5_000_000)),
		XContentCreateCostMicrousd:        int64(getEnvInt("OPENPOST_X_CONTENT_CREATE_COST_MICROUSD", 15_000)),
		XContentCreateWithURLCostMicrousd: int64(getEnvInt("OPENPOST_X_CONTENT_CREATE_WITH_URL_COST_MICROUSD", 200_000)),
