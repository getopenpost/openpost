...
Create a LinkedIn developer app and enable the products that match the account types you will connect. Add the exact callback below under the app's OAuth redirect URLs:
