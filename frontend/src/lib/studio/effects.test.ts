...
import type { StudioShadowEffect, StudioTextCurve } from './types';

const shadow: StudioShadowEffect = {
	color: '#f97316',
	opacity: 0.5,
	blur: 20,
	angle: 90,
...
function curve(type: StudioTextCurve['type']): StudioTextCurve {
	return { type, strength: 0.7, offset: 0.25, reverse: false };
}

describe('Studio layer effects', () => {
