...
export interface VideoPresentation {
	...
	keyframes?: Partial<
		Record<'position_x' | 'position_y' | 'scale' | 'rotation' | 'opacity', NumericKeyframe[]>
	>;
}

export type VideoPresentationOverride = Partial<
	Omit<VideoPresentation, 'keyframes'> & { keyframes: VideoPresentation['keyframes']; visible: boolean }
>;
...
export interface BaseTimelineItem {
	...
	duration_us: number;
	visible: boolean;
	variant_overrides?: Partial<Record<VariantID, { visible?: boolean; presentation?: VideoPresentationOverride }>>;
}
