	...
	const workflow = [
		{
			...
			description: 'Start with the text, media, and time that each account can share.'
		},
		{
			title: 'Tailor and preview',
			description: 'Change the copy, format, media, and settings for each account.'
		},
		{
...
<section class="overflow-hidden border-b">
	<div class="marketing-shell py-14 sm:py-20 lg:py-24">
		<div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
			<div>
				<p class="section-label">Social publishing for each platform</p>
				<h1 class="marketing-title mt-4">Create once. Preview every destination.</h1>
			</div>
			<div class="lg:pb-1">
				<p class="marketing-copy">
					Write one post, tailor the copy and format for each account, and see what people
