...
const outputDirectory = join(repository, 'frontend/static/video-studio-audio/assets');
const generatedModule = join(
	repository,
	'frontend/src/lib/video-studio/bundled-audio.generated.ts'
);
const manifestPath = join(repository, 'frontend/static/video-studio-audio/manifest.json');
...
for (let index = 0; index < definitions.length; index += 1) {
	...
	assets.push({
		...
		name,
		kind,
		path: `/video-studio-audio/assets/${filename}`,
		mime_type: 'audio/wav',
