...
export function hexToRGB(value: string): StudioRGB {
...
export function rgbToHex({ r, g, b }: StudioRGB): string {
	return `#${[r, g, b]
		.map((value) =>
...
export function rgbToHSL({ r, g, b }: StudioRGB): StudioHSL {
...
export function hslToRGB({ h, s, l }: StudioHSL): StudioRGB {
...
export function hslToHex(value: StudioHSL): string {
