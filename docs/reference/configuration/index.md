...
- Social networks: [provider application](provider-applications.md) ownership, client keys, callback addresses, and server-specific settings
- Custom destinations: [connector](custom-connectors.md) services installed by a self-hosted operator
...
For the full list, start with [Environment Variables](environment-variables.md).
