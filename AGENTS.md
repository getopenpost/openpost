...
- Keep feature identity SVGs in `assets/brand/features/` for the README and public materials. The application uses the theme icon system for page, navigation, and action icons; do not render or distribute feature artwork to the app. Preserve the protected Converge logo.
- Keep marketing illustration colors in paired public light/dark tokens. Preserve its green, blue, and lilac palette alongside orange action accents. Do not change authenticated organization themes to style public campaigns.
