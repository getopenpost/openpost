...
<script lang="ts">
	...
	import RecordingRecoveryBanner from '$lib/video-editor/components/recording-recovery-banner.svelte';
...
>
	...
	>
		...
		<div class="flex min-w-24 items-center justify-end gap-2 text-xs text-[oklch(0.65_0.015_55)]">
			...
			<Button
				...
				variant="ghost"
				size="sm"
				aria-label={m.video_editor_record()}
	...
	{:else}
		{#key projectId}
			<RecordingRecoveryBanner {projectId} onRecovered={handleRecordingInserted} />
			<SequenceTabs
