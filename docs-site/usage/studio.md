...
Studio saves soon after you stop editing. Public designs stay on the current device. Workspace designs are saved to OpenPost. Changes that have not reached the server also stay in this browser for seven days. If another browser changes the same design, Studio does not overwrite it. You can reload the saved version, save your local work as a copy, or keep editing locally.
