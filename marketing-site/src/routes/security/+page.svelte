	...
	<div class="marketing-shell grid gap-12 lg:grid-cols-[0.68fr_1.32fr]">
		<div>
			...
			<p class="mt-4 text-sm leading-6 text-muted-foreground">
				OpenPost keeps social account keys apart from tool access. A full-access token can still make
				changes.
			</p>
		</div>
	...
	<div class="marketing-shell">
		<div class="grid gap-10 lg:grid-cols-[0.7fr_1.3fr]">
			<div>
				...
				<h2 class="mt-4 text-3xl font-semibold text-balance">Know who controls each part.</h2>
				<p class="mt-4 text-sm leading-6 text-muted-foreground">
					Open source lets you review the app. It does not secure a server, social account,
					or backup by itself.
				</p>
			</div>
			<div class="divide-y border-y">
