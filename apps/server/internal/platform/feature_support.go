...
func SupportsAnalytics(platformName string, capabilityState string) bool {
	switch platformName {
	case "x", "bluesky", "mastodon", "pixelfed", "peertube", "lemmy", "piefed", "facebook", "instagram", "threads", "youtube", "tiktok":
		return true
	case "linkedin":
...
func SupportsEngagement(platformName string) bool {
	switch platformName {
	case "facebook", "instagram", "linkedin", "threads", "mastodon", "pixelfed", "peertube", "lemmy", "piefed", "bluesky", "x", "youtube":
		return true
	default:
		return false
	}
