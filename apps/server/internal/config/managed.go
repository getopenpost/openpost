...
var managedSettingDefinitions = []ManagedSettingDefinition{
	...
	{Key: "OPENPOST_OAUTH_DYNAMIC_REGISTRATION_ENABLED", Group: "authentication", Label: "OAuth dynamic client registration", Description: "Allow external applications to register OAuth clients without operator approval.", Kind: ManagedSettingBoolean, EnvVars: []string{"OPENPOST_OAUTH_DYNAMIC_REGISTRATION_ENABLED"}},
	...
	{Key: "OPENPOST_PADDLE_FOUNDER_MONTHLY_PRICE_ID", Group: "billing", Label: "Solo monthly price ID", Description: "Paddle price used for monthly Solo subscriptions.", Kind: ManagedSettingString, Optional: true, EnvVars: []string{"OPENPOST_PADDLE_FOUNDER_MONTHLY_PRICE_ID"}},
	{Key: "OPENPOST_PADDLE_FOUNDER_ANNUAL_PRICE_ID", Group: "billing", Label: "Solo annual price ID", Description: "Paddle price used for annual Solo subscriptions.", Kind: ManagedSettingString, Optional: true, EnvVars: []string{"OPENPOST_PADDLE_FOUNDER_ANNUAL_PRICE_ID"}},
	...
	{Key: "OPENPOST_EMAIL_DELIVERY_WEBHOOK_SECRET", Group: "email", Label: "Email delivery webhook secret", Description: "Write-only HMAC secret used to authenticate delivery outcome callbacks.", Kind: ManagedSettingSecret, Secret: true, Optional: true, EnvVars: []string{"OPENPOST_EMAIL_DELIVERY_WEBHOOK_SECRET"}},
	...
	{Key: "OPENPOST_MEME_GENERATOR_ENABLED", Group: "features", Label: "Meme generator", Description: "Enable OpenPost's built-in meme templates and local renderer.", Kind: ManagedSettingBoolean, EnvVars: []string{"OPENPOST_MEME_GENERATOR_ENABLED"}},
	{Key: "OPENPOST_CONTENT_AI_PROVIDER", Group: "features", Label: "Content AI provider", Description: "Exact OpenRouter provider used for post and meme generation.", Kind: ManagedSettingString, Optional: true, EnvVars: []string{"OPENPOST_CONTENT_AI_PROVIDER"}},
	{Key: "OPENPOST_CONTENT_AI_REQUIRE_ZDR", Group: "features", Label: "Content AI zero retention", Description: "Restrict post and meme generation to OpenRouter endpoints with zero data retention.", Kind: ManagedSettingBoolean, EnvVars: []string{"OPENPOST_CONTENT_AI_REQUIRE_ZDR"}},
	{Key: "OPENPOST_TEXT_GENERATION_MODEL", Group: "features", Label: "Text generation model", Description: "OpenRouter model used to build publication copy from an idea.", Kind: ManagedSettingString, EnvVars: []string{"OPENPOST_TEXT_GENERATION_MODEL"}},
	...
	{Key: "OPENPOST_X_ACCOUNT_HISTORY_READ_REQUESTS_PER_DAY", Group: "providers", Label: "X account-history daily reads", Description: "Maximum X account-history listing requests per connected account each UTC day. Keep zero to disable provider reads.", Kind: ManagedSettingInteger, EnvVars: []string{"OPENPOST_X_ACCOUNT_HISTORY_READ_REQUESTS_PER_DAY"}},
...
var managedSettingBindings = map[string]managedSettingBinding{
	...
	"OPENPOST_OAUTH_DYNAMIC_REGISTRATION_ENABLED":      boolBinding(func(c *Config) *bool { return &c.OAuthDCR }),
	...
	"OPENPOST_EMAIL_DELIVERY_WEBHOOK_SECRET":           stringBinding(func(c *Config) *string { return &c.EmailDeliveryWebhookSecret }),
	...
	"OPENPOST_CONTENT_AI_PROVIDER":                     trimmedStringBinding(func(c *Config) *string { return &c.ContentAIProvider }),
	"OPENPOST_CONTENT_AI_REQUIRE_ZDR":                  boolBinding(func(c *Config) *bool { return &c.ContentAIRequireZDR }),
	"OPENPOST_TEXT_GENERATION_MODEL":                   trimmedStringBinding(func(c *Config) *string { return &c.TextGenerationModel }),
	...
	"OPENPOST_X_ACCOUNT_HISTORY_READ_REQUESTS_PER_DAY": intBinding(func(c *Config) *int { return &c.XAccountHistoryReadRequestsPerDay }),
