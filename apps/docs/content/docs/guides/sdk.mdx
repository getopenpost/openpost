...
Publications created through the official package return `creation_source: "sdk"`.
OpenPost keeps this distinct from raw API calls, CLI commands, MCP tools, web
actions, and automatic posting flows, so reports can show how content was
created without storing high-cardinality client details.
