// oxlint-disable
/**
 * Ported from FreeCut (MIT) - src/shared/timeline/transitions/renderers/index.ts
 */
/**
...
export { registerIrisTransitions } from './iris';
export { registerShapeTransitions } from './shape';
