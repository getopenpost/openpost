...
The **Native mobile Android candidate** job in `.github/workflows/ci.yml` runs when `apps/mobile/`, `apps/web/openapi.json`, `packages/api-contract/`, or `packages/query-catalog/` changes. It:
