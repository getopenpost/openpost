...
<section class="feature-workbench" aria-labelledby="workbench-title">
  <div class="marketing-shell workbench-layout">
    <div class="workbench-intro">
      ...
      <h2 id="workbench-title" class="marketing-heading mt-4">Every station keeps its limits visible.</h2>
    ...
    <div class="feature-rail">
      {#each featureGroups as feature (feature.id)}
        ...
        <article id={feature.id} class="feature-station scroll-mt-28" data-feature-station={feature.id}>
          <div class="station-copy">
            ...
            <div class="station-actions">
              ...
              >
                Read the guide
                {#if isExternal(feature.docsUrl)}<ExternalLink aria-hidden="true" />{:else}<ArrowRight
                    aria-hidden="true"
                  />{/if}
              </a>
              <a
              ...
              >
                {feature.next.label}
                {#if isExternal(feature.next.href)}<ExternalLink aria-hidden="true" />{:else}<ArrowRight
                    aria-hidden="true"
                  />{/if}
              </a>
            </div>
...
<section class="provider-boundary border-y" aria-labelledby="provider-boundary-title">
  <div class="marketing-shell grid gap-10 py-14 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
    <div>
      ...
      <h2 id="provider-boundary-title" class="mt-4 text-3xl font-semibold tracking-[-0.035em] text-balance">
    ...
    <div>
      <p class="text-lg leading-8 text-muted-foreground">
        ...
        {publicProviderCertification.summary} Account type, provider review, granted permissions,
        runtime controls, and current live tests can still change what one account can publish.
      </p>
...
<section class="section-pad text-center" aria-labelledby="features-close-title">
  <div class="marketing-shell">
    ...
    <h2 id="features-close-title" class="marketing-heading mx-auto mt-4">Start with the limits you need now.</h2>
...
<style>
  .features-hero {
    background:
      radial-gradient(circle at 72% 24%, color-mix(in oklch, var(--primary) 12%, transparent), transparent 24rem),
      var(--background);
  }
