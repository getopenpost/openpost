...
export const PROPERTY_VALUE_RANGES = {
	...
	backgroundRotation: { min: -360, max: 360, unit: '°', decimals: 1 },
	backgroundScale: { min: 0.25, max: 4, unit: 'x', decimals: 2 },
	backgroundOffsetX: { min: -1, max: 1, unit: '', decimals: 2 },
	backgroundOffsetY: { min: -1, max: 1, unit: '', decimals: 2 },
	backgroundSmoothness: { min: 0, max: 1, unit: '', decimals: 2 },
	backgroundDensity: { min: 0, max: 1, unit: '', decimals: 2 },
	backgroundForegroundOpacity: { min: 0, max: 1, unit: '', decimals: 2 },
