...
export const platformNames: Record<PreviewPlatform, string> = {
  x: "X",
  mastodon: "Mastodon",
  bluesky: "Bluesky",
  linkedin: "LinkedIn",
...
export function normalizePreviewPlatform(value: string): PreviewPlatform {
...
export function supportsPreviewFormat(
  platform: PreviewPlatform,
  format: PreviewFormat,
): boolean {
