...
Pinterest support remains gated. Review the [Pinterest API documentation](https://developers.pinterest.com/docs/) and request Standard API access. Do not expose it to users until your app has that access and current live certification for each operation you intend to enable.
