// oxlint-disable
/**
 * Ported from FreeCut (MIT) - src/shared/timeline/transitions/registry.ts
 */
/**
 * Transition Registry
 *
...
import type { TransitionDefinition, WipeDirection, SlideDirection, FlipDirection } from './types';
