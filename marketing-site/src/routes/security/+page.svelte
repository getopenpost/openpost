    ...
    <div class="grid gap-12 lg:grid-cols-[1fr_22rem] lg:items-end">
      ...
      <aside class="border-l pl-6">
        ...
        <p class="mt-2 text-sm leading-6 text-muted-foreground">
          Each control below links to its implementation. OpenPost does not
          claim SOC 2, ISO 27001, or an independent penetration test.
        </p>
      </aside>
    </div>
  </div>
...
<section class="section-pad">
  ...
  >
    ...
    <article class="py-7 lg:px-7 lg:last:pr-0">
      ...
      <p class="mt-3 text-sm leading-6 text-muted-foreground">
        Release preflight runs Go vulnerability analysis and a production
        JavaScript dependency audit. A passing scan reduces known dependency
        risk; it is not a security certification.
      </p>
      <a
