...
| [altstackHQ/altstack-data](https://github.com/altstackHQ/altstack-data) | Marketing, Hootsuite alternative | submitted | [PR #30](https://github.com/altstackHQ/altstack-data/pull/30) | Self-hosted social publishing and scheduling software with API, CLI, and MCP access. | None | 2026-07-26 | Links OpenPost from Hootsuite and adds neutral machine-readable project metadata without claiming an AltStack deployment package. |
