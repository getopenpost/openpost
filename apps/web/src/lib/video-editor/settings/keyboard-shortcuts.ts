...
export const DEFAULT_EDITOR_SHORTCUTS = {
	...
	EXPAND_LEFT_SIDEBAR: 'mod+alt+left',
	EXPAND_RIGHT_SIDEBAR: 'mod+alt+right',
	TOGGLE_THEATER_MODE: 't',
...
export const EDITOR_SHORTCUT_DEFINITIONS: readonly EditorShortcutDefinition[] = [
	...
	{ id: 'TOGGLE_LEFT_SIDEBAR', section: 'project' },
	{ id: 'TOGGLE_RIGHT_SIDEBAR', section: 'project' },
	{ id: 'EXPAND_LEFT_SIDEBAR', section: 'project' },
	{ id: 'EXPAND_RIGHT_SIDEBAR', section: 'project' },
	{ id: 'TOGGLE_THEATER_MODE', section: 'project' },
