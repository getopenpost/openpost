...
| [n8n workflows](/automate/n8n)          | You want a visual workflow started by a timer, webhook, or another node |
...
The [API reference](/api-reference) remains the source for every HTTP operation and schema. The guides in this section explain common workflows and decisions.
