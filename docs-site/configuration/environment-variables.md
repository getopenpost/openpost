...
| `OPENPOST_POSTHOG_BROWSER_HOST`          |                                    No | API host for self-hosting, Hosted service proxy | Browser ingestion endpoint or first-party reverse proxy. Cloud mode defaults to `https://cool.openpost.social`; an explicit value overrides that default.                                                                          |
