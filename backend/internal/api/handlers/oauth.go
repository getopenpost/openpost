...
type AccountResponse struct {
	...
	LimitProfile           string `json:"limit_profile" enum:"standard,x-premium" doc:"Account-specific publishing limit profile"`
...
func accountResponse(acc models.SocialAccount, disableLinkedInThreadReplies bool) AccountResponse {
	...
	return AccountResponse{
		...
		CapabilityCheckedAt:    acc.CapabilityCheckedAt,
