...
The container health check uses `/api/v1/health`; this explicit readiness check also proves that the database is available. See [Health Checks](../operations/health-checks.md).
...
- [Production checklist](../configuration/production-checklist.md)
- [Provider setup](../providers/index.md)
